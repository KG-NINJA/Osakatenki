...
Generates reproducible daily forecasts without network access and writes a
static HTML page suitable for deployment via GitHub Pages or other static
hosting. The model captures seasonal baselines, diurnal temperature swings,
and stochastic disturbances to keep the outlook lively while remaining
